...
def aStar(grid,start,goal,h_new):
    ...
    while not openSet.empty():
        ...
        #if((current_row,current_column) not in h_new.keys()):
        #    h_new[(current_row,current_column)] = 0
        ...
        for neighbor in grid.neighbors(grid.getCell(current_row,current_column)):
            ...
            #if (neighbor.row,neighbor.column) in [i[1]for i in openSet.elements] and tentative_g_score > g_score.get((neighbor.row,neighbor.column),0):
            #    continue
